...
$log(\mu_{ijkl})=\alpha + \beta_{1}(taxa)_{ijkl} + \beta_{2}(licença)_{ijkl} + \beta_{3}(renda)_{ijkl} + \beta_{4}(estradas)_{ijkl}$
...
$log(\mu_{ijkl})=\alpha + \beta_{1}(taxa)_{ijkl} + \beta_{2}(licença)_{ijkl} + \beta_{3}(renda)_{ijkl}$
...
Beta(Taxa): -0.049; $\mu$ = exp(beta) = 0.95. O consumo de combustível diminui 5% com o incremento na taxa.

Gamma(licença): 2.349; $\mu$ = exp(gamma) = 10.474. o consumo de combustível aumenta 10 vezes com o aumento do número de motoristas licenciados

Delta(renda): -0.0001; $\mu$ = exp(delta) = 0.999. o consumo de combustível diminui 0,1% com o aumento da renda per capita.
